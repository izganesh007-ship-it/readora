...
await query(`INSERT INTO admins(email,password_hash,role) VALUES($1,$2,'OWNER')
   ON CONFLICT(email) DO UPDATE SET password_hash=EXCLUDED.password_hash, role='OWNER', updated_at=now()`, [email, passwordHash]);
